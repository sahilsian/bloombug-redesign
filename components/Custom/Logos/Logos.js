        ...
        <div className="flex justify-center items-center opacity-85 gap-10 flex-wrap">
            {
                logo_1.url && (
                    <div className="min-w-[100px] max-w-[150px] flex justify-center">
                        <Link href={logo_1_link || router.asPath}>
            ...
            }
            {
                logo_2.url && (
                    <div className="min-w-[100px] max-w-[150px] flex justify-center">
                        <Link href={logo_2_link || router.asPath}>
            ...
            }
            {
                logo_3.url && (
                    <div className="min-w-[100px] max-w-[150px] flex justify-center">
                        <Link href={logo_3_link || router.asPath}>
            ...
            }
            {
                logo_4.url && (
                    <div className="min-w-[100px] max-w-[150px] flex justify-center">
                        <Link href={logo_4_link || router.asPath}>
            ...
            }
            {
                logo_5.url && (
                    <div className="min-w-[100px] max-w-[150px] flex justify-center">
                        <Link href={logo_5_link || router.asPath}>
            ...
            }
            {
                logo_6.url && (
                    <div className="min-w-[100px] max-w-[150px] flex justify-center">
                        <Link href={logo_6_link || router.asPath}>
